      ...
      <SharedLayout>
        <div className="fontInter px-4 max-w-[90rem] mx-auto">
          <div className="lg:w-[830px] mx-auto text-center lg:pt-[88px] pt-12">
            <h1 className="lg:text-5xl text-3xl lg:leading-[60px] font-semibold text-white">
              {data?.title || ''}
            </h1>
            <p className="text-white/[0.7] text-xl px-10 pt-6">
              {data?.description || ''}
            </p>
          </div>
          <div className="lg:mx-36 mt-16 lg:mb-24 mb-8">
            <img
              ...
              alt="blog"
              className="object-covor w-full"
            />
            <div className="flex justify-between  mt-8">
              <div className="flex gap-x-16">
                <div className="flex  flex-col gap-y-3">
                  <p className={styles.gradientText}>Written by</p>
                  <p className="text-white/[0.5] text-lg font-medium">
                    {data?.author || ''}
                  </p>
                </div>
                <div className="flex flex-col gap-y-3">
          ...
          <>
            <div className="lg:mx-36 mt-10 xxs:mt-48">
              ...
              <p className="text-xl font-normal mt-5 text-white/[0.85]">
          ...
          <div className="lg:px-24 lg:py-12 lg:my-24 grid grid-cols-11 lg:mx-28 p-4 bg-white/[0.05] rounded-2xl">
            <div className="col-span-12 lg:col-span-7">
              <p className="lg:text-5xl text-3xl font-semibold text-white mb-5">
                Stay in the know
              </p>
              <p className="lg:text-2xl text-xl font-medium lg:pr-24 pb-2 text-white/[0.85]">
                Get the latest news, resources, Creators and exclusive events
