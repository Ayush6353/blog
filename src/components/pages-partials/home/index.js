...
import { animateUp } from '../../../components/animation/index'
            ...
            <section className="container mx-auto px-6 p-10">
              <div className="flex items-center flex-wrap mb-20">
                <div className="w-full md:w-1/2 md:pr-10">
                  <h4
                    className={`${styles.headingText} text-3xl font-bold mb-3`}
                  >
                    Our mission
                  </h4>
                  <p className="text-gray-200 mb-8">
                    Our mission is to provide high-quality, informative, and
                    engaging content on a variety of topics, ranging from
                    technology and science to lifestyle and entertainment. We
                    believe that everyone deserves to have access to reliable
                    information that can help them make better decisions and
                    improve their lives.
                  </p>
                </div>
              ...
              <div className="flex items-center flex-wrap mb-20">
                <div className="w-full md:w-1/2">
                  <img
                    className="rounded-lg"
                    src="https://images.unsplash.com/photo-1562577308-c8b2614b9b9a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTJ8fHRlYW18ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60"
                    alt="Team"
                  />
                </div>
                <div className="w-full md:w-1/2 md:pl-10">
                  ...
                  <p className="text-gray-200 mb-8">
                    Our team consists of experts in their respective fields who
                    bring their unique perspectives and insights to our
                    articles. We're committed to conducting thorough research
                    and fact-checking to ensure the accuracy and credibility of
                    our content.
                  </p>
                </div>
              </div>
              <div className="flex items-center flex-wrap mb-20">
                <div className="w-full md:w-1/2 md:pr-10">
                  ...
                  <p className="text-gray-200 mb-8">
                    Whether you're looking to learn something new, stay
                    up-to-date with the latest trends, or simply enjoy some
                    entertaining reads, we've got you covered. We also encourage
                    our readers to share their thoughts and opinions in the
                    comments section, as we believe that constructive
                    discussions can enrich everyone's understanding of the
                    topics we cover.
                  </p>
                </div>
                <div className="w-full md:w-1/2">
                  <img
                    className="rounded-lg"
                    src="https://images.unsplash.com/photo-1570872309681-828bdb21903c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8c3RheSUyMHVwJTIwdG8lMjBkYXRlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
                    alt="Syncing"
                  />
                </div>
              </div>
              ...
              <div className="container mx-auto px-6 py-20">
                ...
                <div className="flex flex-wrap">
                  <div className="w-full h-auto md:w-1/3 px-2 mb-4">
                    <div className="flex flex-col justify-between h-full bg-gray-200 rounded shadow py-2">
                      <p className="text-gray-800 text-base px-6 mb-5">
                        ...
                        In fact, you look strong enough to pull the ears off a
                        Gundark. Thanks to you.
                      </p>
                  ...
                  <div className="w-full h-auto md:w-1/3 px-2 mb-4">
                    <div className="flex flex-col justify-between h-full bg-gray-200 rounded shadow py-2">
                      <p className="text-gray-800 text-base px-6 mb-5">
                        That's two you owe me, junior. Well your Worship, looks
                        like you managed to keep me around for a little while
                        longer. I had nothing to do with it.
                      </p>
                      <p className="text-gray-500 text-xs md:text-sm px-6">
                  ...
                  <div className="w-full h-auto md:w-1/3 px-2 mb-4">
                    <div className="flex flex-col justify-between h-full bg-white bg-gray-200 rounded shadow py-2">
                      <p className="text-gray-800 text-base px-6 mb-5">
                        General Rieekan thinks it's dangerous for any ships to
                        leave the system until we've activated the energy
                        shield. That's a good story. I think you just can't bear
            ...
            >
              <section className="mt-7 bg-[#e0defa]">
                <div className="container mx-auto px-6 text-center py-20">
                  <h2 className="mb-6 text-4xl font-bold text-center text-[#0a0536]">
                    About Me
                  </h2>
